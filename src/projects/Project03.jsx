...
const Project03 = ({ isVisible = true }) => {
  ...
  const projectInfo = {
    ...
    description: "Located in the heart of Chennai's urban sprawl, this artist's studio is a quiet rebellion against the generic."
  };
  ...
  const getItemMargin = (index, itemType, isFirstContentItem) => {
    ...
    if (isFirstContentItem) {
      // Updated to match Project01 and Project02 style
      return { marginLeft: 'clamp(43vw, 54vw, 60vw)' }; // Same as Project01 and Project02
    } else {
